...
#stock_name = 'EOD/MSFT'
quandl.ApiConfig.api_key = 'vy3BVvgn4_v3rTfEzsx2'
#data = quandl.get_table('WIKI/PRICES')


# Plot of E.ON(a big scale energy company in Europe)
#stock prices since beginning of 2019 (up to July)
'''prices = quandl.get(stock_name, api_key='vy3BVvgn4_v3rTfEzsx2', \
...
S_eon = quandl.get(stock_name, api_key='vy3BVvgn4_v3rTfEzsx2',
               authtoken="your_authorization_token",
